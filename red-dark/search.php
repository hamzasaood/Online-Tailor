   <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="../index.php" class="logo"><i class="md md-terrain"></i> <span>Admin Dashboard </span></a>
                    </div>
                </div>
                        ...
                        <ul class="nav navbar-right float-right list-inline">
                            ...
                            <li class="dropdown open">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="pupdate.php?id=<?php echo $_SESSION['u_id']; ?>" class="dropdown-item"><i class="md md-lock mr-2"></i> Change Password</a></li>
