...
!function($) {
    ...
    FlotChart.prototype.createCombineGraph = function(selector, ticks, labels, datas) {
        ...
        FlotChart.prototype.init = function() {
          ...
          var datas = [20,30, 15];
          var colors = ["#ececec", "#ea6967", "#fab249"];
          this.createPieGraph("#pie-chart #pie-chart-container", pielabels , datas, colors);


            //real time data representation
            var plot = this.createRealTimeGraph('#flotRealTime', this.randomData() , ['#ea6967']);
            plot.draw();
            var $this = this;
            function updatePlot() {
          ...
          var donutcolors = ["#ea6967", "#fab249", "#ececec","#60b1cc","#4998fa"];
