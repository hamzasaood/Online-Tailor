            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h2 class="pull-left page-title">Shops</h2>
...
<?php
				$sql = "SELECT * FROM signup where u_type='shop'";
				...
				<tr class="even">
				<td class=" sorting_1"><?=$row->shop_name ?></td>
					
				
			<td class="center  ">
				
				
				<a class="btn btn-danger" href="sdel.php?id=<?=$row->u_id?>">
