...
if(isset($_GET['id']))
			{
				...
				$result = $mysqli->query( "SELECT * FROM signup WHERE u_id = $id ");
				if(!empty($result))
				{     
...
<?php 
          ...
          if(isset($_POST['pass']))
				{ 
					...
					$result = $mysqli->query( "update signup 
					set password='$pass' where u_id='$id'"  );
					if(isset($result))
					{
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="textinput" name="pass" type="password" placeholder="Enter New password" required class="form-control input-md"  >
