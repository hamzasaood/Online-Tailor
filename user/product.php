            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h2 class="pull-left page-title">Yours Orders </h2>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-12">
                                                <table id="datatable" class="table-responsive table table-striped table-bordered " style="border-collapse: collapse; border-spacing: 0; width: 150%;">
                                                    <thead>
                                                        <tr>
                                                            <th>Name</th>
															<th>Catagory</th>
...
<?php
				...
				<td class=" sorting_1"><?=$row->name ?></td>
                        ...
                        $s = "SELECT * FROM tb_cat where c_id='$id'";
