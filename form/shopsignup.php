...
$sql = "INSERT INTO signup(f_name,l_name,email,no,address,city,province,password,u_type,shop_name)
VALUES ('$t0','$t1','$t2','$t3','$t4','$t5','$t6','$t7','shop','$t8')";
                    ...
                    <a class="hiddenanchor" id="tologin"></a>
                        ...
                        <div id="login" class="animate form">
                            <form  action="" method="post" autocomplete="on"> 
                                ...
                                <p> 
                                    <label for="province" class="province" data-icon="u" > Shop Name </label>
                                    <input  id="province" name="shop_name" required="required" type="text" placeholder="KPK"/>
                                </p>
