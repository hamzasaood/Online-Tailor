	...
	if(in_array($type, array('gif', 'jpg', 'jpeg', 'png', 'JPG', 'GIF', 'JPEG', 'PNG'))) {
		if(is_uploaded_file($_FILES['image']['tmp_name'])) {			
			if(move_uploaded_file($_FILES['image']['tmp_name'], $url)) {
					...
					set name='$name',price='$price',description='$des',c_id='$cat',image='$url',dat='$d8'
					where p_id='$id' and shop_name='$shop'" );
					if(isset($result))
					{
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="textinput" name="name" type="text" placeholder="Product name" required class="form-control input-md" value="<?php echo $name; ?>" required="">
...
echo "<select class='form-control input-md'  name='cat' required>";
...
?>		    
  ...
  <label class="col-md-4 control-label" for="textinput"></label>  
  <div class="col-md-5">
  <input id="textinput" required name="price" type="text" placeholder="Price" class="form-control input-md" value="<?php echo $price; ?>" required="">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput"></label>  
  <div class="col-md-5">
   <textarea class="form-control input-md" name="des" placeholder="Enter product desc" value="<?=$des;?>" required ></textarea>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput"></label>  
  <div class="col-md-5">
  <input id="textinput" required name="image" type="file" placeholder="" class="form-control input-md" >
