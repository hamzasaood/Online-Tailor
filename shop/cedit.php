...
<?php 
          ...
          if(isset($_POST['name']))
				{ 
					...
					$result = $mysqli->query( "update tb_cat 
					set name='$name',des='$des'
					where c_id='$id' and shop_name='$shop'" );
					if(isset($result))
					{
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="textinput" name="name" type="text" placeholder="Catagory name" class="form-control input-md" value="<?php echo $name; ?>" required="">
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput"></label>  
  <div class="col-md-5">
  <input id="textinput" name="des" type="text" placeholder="Description" class="form-control input-md" value="<?php echo $des; ?>" required="">
