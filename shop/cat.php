            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h2 class="pull-left page-title">Catagories</h2>
                                
                            </div>
                        </div>
<a class="btn btn-info" href="cadd.php">
...
<?php
				...
				$sql = "SELECT * FROM tb_cat where shop_name='$shop'";
				...
				<td class=" sorting_1"><?=$row->name ?></td>
					<td class=" sorting_1"><?=$row->des ?></td>
				
			<td class="center  ">
				
				<a class="btn btn-success" href="cedit.php?id=<?=$row->c_id?>">
					
					Edit
				</a>
				<a class="btn btn-danger" href="cdelete.php?id=<?=$row->c_id?>">
