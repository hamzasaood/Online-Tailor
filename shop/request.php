            ...
            <div class="content-page">
                ...
                <div class="content">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <h2 class="pull-left page-title">Orders</h2>
...
<?php    
   ...
   $shop=$_SESSION['shop_name'];
				$sql = "SELECT * FROM tb_order where shop_name='$shop'";
...
while ($rw = $res->fetch_object()){
 ...
 $no=$rw->no;
				...
				<td class=" sorting_1"><?=$fname; ?></td>
								...
								$ss = "SELECT * FROM products where p_id='$pid' AND shop_name='$shop' ";
...
echo $rwo->name;
                          ...
                          <td class=" sorting_1"><?=$qty; ?></td>
                       			<td class=" sorting_1"><?php
								$ssd = "SELECT * FROM tb_cat where c_id='$cid' and shop_name='$shop'";
...
echo $rwos->name;
			...
			<td class="sorting_1  ">
               ...
               elseif($row->status==2){
				...
				?>
				<a  value="" class="btn btn-success" href="accept.php?id=<?php echo $mid;?>">
					
					Accept
				</a>
				
				<a class="btn btn-danger" href="reject.php?id=<?php echo $mid;?>">
