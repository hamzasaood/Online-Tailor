...
$orderSql = "SELECT * FROM signup ";
$orderQuery = $mysqli->query($orderSql);
$users = $orderQuery->num_rows;

$o = "SELECT * FROM tb_cat where shop_name='$shop' ";
$or = $mysqli->query($o);
$cat = $or->num_rows;

$os = "SELECT * FROM tb_order where shop_name='$shop' ";
$orr = $mysqli->query($os);
$cate = $orr->num_rows;

$oss = "SELECT * FROM tb_order where status='0' and shop_name='$shop' ";
$orrs = $mysqli->query($oss);
$po = $orrs->num_rows;
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="mini-stat clearfix bx-shadow bg-white">
                                    ...
                                    <div class="mini-stat-info text-right text-dark">
                                        <span class="counter text-dark"><?php echo $po; ?></span>
                                        Pending Orders
                                    </div>
                                    <div class="tiles-progress">
                                        <div class="m-t-20">
